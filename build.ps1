...
param(
	[ValidateSet("vs2019", "nupkg", "nupkg-only")]
...
try
{
	...
	switch -Exact ($Target)
	{
		...
		#TODO: Add VS2022 to ValidateSet when released/tested
		"vs2022"
		{
			VSX v143
		}
